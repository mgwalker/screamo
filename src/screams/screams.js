const outputs = [
  ...
  "CONFIRMATION BIAS",
  "DANCE LIKE EVERYONE IS WATCHING AND THEN SCREAM AT THEM FOR WATCHING",
  ...
  "I SCREAM, YOU SCREAM, NO YOU DON'T SCREAM, ONLY I SCREAM",
  ...
  "IF AT FIRST YOU DON'T SUCCEED, SCREAM, SCREAM AGAIN",
  ...
  "LITERALLY SCREAMING",
  "LITTLE JACK HORNER SAT IN A CORNER EATING HIS PUDDING AND PIE",
  "LMFAO",
  ...
  "NOBODY PUTS SCREAMO IN A CORNER",
  ...
  "PANIC AT THE DISCO! PANIC AT THE GROCERY STORE! PANIC IN THE CAR! PANIC EVERYWHERE ALL THE TIME!",
  "PEOPLE CARE ABOUT YOUUUUUUUUU!!!!",
  "PERSIST",
  "PERSIST, JUST LIKE HER",
  "PET IT",
  "PET THE BIRB",
  "PET THE DOGGO",
  "PET THE FISH",
  ...
  "YOU'RE A GROWNUP, YOU CAN DO WHATEVER YOU WANT!!!! LIKE SCREAM",
  "YOU'RE A GROWNUP, YOU CAN SCREAM WHATEVER YOU WANT",
  "YOU'RE NOT THE BOSS OF ME",
  "NO. NO. NO. NO. NO. NO. NO. NO. NO. NO. NO. NO. NO. NO. NO.",
];

export default () => outputs[Math.floor(Math.random() * outputs.length)];
